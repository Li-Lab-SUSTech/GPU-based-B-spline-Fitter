...
% This file is part of GPUmleFit_LM_multiD Fitter.
%%
classdef MultiD_fitter_GUI<handle
    properties
        guihandles
        smappos
        mij
    ...
    methods
        function obj=MultiD_fitter_GUI(varargin)  
            ...
            figureheight=630;
            h=figure('Name','MultiD fitter','MenuBar','none','ToolBar','none');
...
%             obj.guihandles.title=uicontrol('style','text','String','A GPU-accelerated B-spline Fitter for Multi-dimensional Single Molecule Localization Microscopy. (c) 2023 Li lab','Position',[xpos1,top-vsep+10,xw*4.5,vsep],'FontSize',10,'HorizontalAlignment',hatitle,'FontWeight','bold');
            obj.guihandles.title=uicontrol('style','text','String','B-spline Fitter for Multi-dimensional SMLM. (c) 2023 Li lab','Position',[xpos1,top-vsep+10,xw*4.5,vsep],'FontSize',10,'HorizontalAlignment',hatitle,'FontWeight','bold');
            ...
            obj.guihandles.loader=uicontrol('style','popupmenu','String',{'simple tif','ome loader','ImageJ'},'Position',[xpos1+1.5*xw,top-3*vsep,xw*2.5,vsep],'FontSize',fontsize,'Callback',@obj.changeloader_callback,'Value',1);
            ...
            obj.guihandles.conversion=uicontrol('style','edit','String','0.74','Position',[xpos1+xw*1.5,top-9*vsep,xw*.5,vsep],'FontSize',fontsize);
            ...
            obj.guihandles.backgroundmode=uicontrol('style','popupmenu','String',{'Difference of Gaussians (fast)','None','Conv PSF'},'Position',[xpos1+xw*2,top-12*vsep,xw*2,vsep],'FontSize',fontsize);
            ...
            obj.guihandles.peakcutoff=uicontrol('style','edit','String','10','Position',[xpos1+xw*3.5,top-13*vsep,xw*.5,vsep],'FontSize',fontsize);
            ...
            obj.guihandles.roifit=uicontrol('style','edit','String','15','Position',[xpos1+xw*1.5,top-16*vsep,xw*.5,vsep],'FontSize',fontsize);
            ...
            obj.guihandles.agg=uicontrol('style','checkbox','String','Aggregation','Position',[xpos1,top-17*vsep,xw*1,vsep],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.agg.TooltipString=sprintf('Check this option for a aggregation dataset.');
            
            obj.guihandles.conv=uicontrol('style','checkbox','String','Conv filter','Position',[xpos1+xw*3,top-17*vsep,xw*1,vsep],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.conv.TooltipString=sprintf('Check this option for conv filter.');
            
%             obj.guihandles.roifitt=uicontrol('style','text','String','ROI size (pixel)','Position',[xpos1,top-17*vsep,xw*1.5,vsep],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.aggsize=uicontrol('style','edit','String','1','Position',[xpos1+xw*1.5,top-17*vsep,xw*.5,vsep],'FontSize',fontsize);
            obj.guihandles.aggsize.TooltipString=sprintf('Size of the aggregation region (roi size).'); 
            obj.guihandles.aggsize.TooltipString=obj.guihandles.aggsize.TooltipString;
            ...
            obj.guihandles.mirror=uicontrol('style','checkbox','String','mirror','Position',[xpos1+xw*2.4,top-16*vsep,xw*1,vsep],'FontSize',fontsize);
            ...
            %
            obj.guihandles.fourDfit=uicontrol('style','checkbox','String','4D fit','Position',[xpos1+3*xw,top-16*vsep,xw*1,vsep],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.fourDfit.TooltipString=sprintf('Check this option for a 4D dataset to enable higher dimension fitting.'); 
            %5D
            obj.guihandles.fiveDfit=uicontrol('style','checkbox','String','5D fit','Position',[xpos1+3.6*xw,top-16*vsep,xw*1,vsep],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.fiveDfit.TooltipString=sprintf('Check this option for a 5D dataset to enable higher dimension fitting.');
        ...
        function p=getguiparameters(obj)
            ...
            p.aggsz=str2double(obj.guihandles.aggsize.String);
            ...
            p.fourD=(obj.guihandles.fourDfit.Value);
            p.fiveD=(obj.guihandles.fiveDfit.Value);
            p.agg=(obj.guihandles.agg.Value);
            p.conv=(obj.guihandles.conv.Value);
