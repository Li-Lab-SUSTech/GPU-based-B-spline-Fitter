...
{
	kernel_bsplineMLEFit_z_EMCCD << <dimGrid, dimBlock >> > (d_data, d_coeff, spline_xsize, spline_ysize, spline_zsize, sz, iterations, d_Parameters, d_CRLBs, d_LogLikelihood, Nfits, deg, temp);
}
...
{
	kernel_bsplineMLEFit_4D_EMCCD << <dimGrid, dimBlock >> > (d_data, d_coeff, spline_xsize, spline_ysize, spline_zsize, spline_wsize, sz, iterations, d_initP4, d_Parameters, d_CRLBs, d_LogLikelihood, Nfits, deg);
}
