...
function [dudt,model] = kernel_Derivative_bSpline4D(xi,yi,zi,wi,nDatax,nDatay,nDataz,nDataw,cMat,delta_f,delta_dfx,delta_dfy,delta_dfz,delta_dfw,theta)
    ...
    for q = 1:2
        for j = 1:2
            for i = 1:2
                ...
                f = f+ ...
                    cMat(ky-i+my,kx-j+mx,kz-q+mz,kw-r+mw)* delta_f(16*nIndex+1)+ ...
                    cMat(ky+i-1+my,kx-j+mx,kz-q+mz,kw-r+mw)* delta_f(16*nIndex+2)+ ...
                    cMat(ky-i+my,kx+j-1+mx,kz-q+mz,kw-r+mw)* delta_f(16*nIndex+3)+ ...
                    cMat(ky+i-1+my,kx+j-1+mx,kz-q+mz,kw-r+mw)* delta_f(16*nIndex+4)+ ...
                    cMat(ky-i+my,kx-j+mx,kz+q-1+mz,kw-r+mw)* delta_f(16*nIndex+5)+ ...
                    cMat(ky+i-1+my,kx-j+mx,kz+q-1+mz,kw-r+mw)* delta_f(16*nIndex+6) + ...
                    cMat(ky-i+my,kx+j-1+mx,kz+q-1+mz,kw-r+mw)* delta_f(16*nIndex+7) + ...
                    cMat(ky+i-1+my,kx+j-1+mx,kz+q-1+mz,kw-r+mw)* delta_f(16*nIndex+8)+...
                    cMat(ky-i+my,kx-j+mx,kz-q+mz,kw+r+mw-1)* delta_f(16*nIndex+9)+ ...
                    cMat(ky+i-1+my,kx-j+mx,kz-q+mz,kw+r+mw-1)* delta_f(16*nIndex+10)+ ...
                    cMat(ky-i+my,kx+j-1+mx,kz-q+mz,kw+r+mw-1)* delta_f(16*nIndex+11)+ ...
                    cMat(ky+i-1+my,kx+j-1+mx,kz-q+mz,kw+r+mw-1)* delta_f(16*nIndex+12)+ ...
                    cMat(ky-i+my,kx-j+mx,kz+q-1+mz,kw+r+mw-1)* delta_f(16*nIndex+13)+ ...
                    cMat(ky+i-1+my,kx-j+mx,kz+q-1+mz,kw+r+mw-1)* delta_f(16*nIndex+14) + ...
                    cMat(ky-i+my,kx+j-1+mx,kz+q-1+mz,kw+r+mw-1)* delta_f(16*nIndex+15) + ...
                    cMat(ky+i-1+my,kx+j-1+mx,kz+q-1+mz,kw+r+mw-1)* delta_f(16*nIndex+16);
                
                
                
                dfx = dfx+ ...
                    (-1*cMat(ky-i+my,kx-j+mx,kz-q+mz,kw-r+mw)+cMat(ky-i+my+1,kx-j+mx,kz-q+mz,kw-r+mw))* delta_dfx(16*nIndex+1)+ ...
                    (-1*cMat(ky+i-1+my,kx-j+mx,kz-q+mz,kw-r+mw)+cMat(ky+i-1+my+1,kx-j+mx,kz-q+mz,kw-r+mw))* delta_dfx(16*nIndex+2)+ ...
                    (-1*cMat(ky-i+my,kx+j-1+mx,kz-q+mz,kw-r+mw)+cMat(ky-i+my+1,kx+j-1+mx,kz-q+mz,kw-r+mw))* delta_dfx(16*nIndex+3)+ ...
                    (-1*cMat(ky+i-1+my,kx+j-1+mx,kz-q+mz,kw-r+mw)+cMat(ky+i-1+my+1,kx+j-1+mx,kz-q+mz,kw-r+mw))* delta_dfx(16*nIndex+4)+ ...
                    (-1*cMat(ky-i+my,kx-j+mx,kz+q-1+mz,kw-r+mw)+cMat(ky-i+my+1,kx-j+mx,kz+q-1+mz,kw-r+mw))* delta_dfx(16*nIndex+5)+ ...
                    (-1*cMat(ky+i-1+my,kx-j+mx,kz+q-1+mz,kw-r+mw)+cMat(ky+i-1+my+1,kx-j+mx,kz+q-1+mz,kw-r+mw))* delta_dfx(16*nIndex+6) + ...
                    (-1*cMat(ky-i+my,kx+j-1+mx,kz+q-1+mz,kw-r+mw)+cMat(ky-i+my+1,kx+j-1+mx,kz+q-1+mz,kw-r+mw))* delta_dfx(16*nIndex+7) + ...
                    (-1*cMat(ky+i-1+my,kx+j-1+mx,kz+q-1+mz,kw-r+mw)+cMat(ky+i-1+my+1,kx+j-1+mx,kz+q-1+mz,kw-r+mw))* delta_dfx(16*nIndex+8)+...
                    (-1*cMat(ky-i+my,kx-j+mx,kz-q+mz,kw+r+mw-1)+cMat(ky-i+my+1,kx-j+mx,kz-q+mz,kw+r+mw-1))* delta_dfx(16*nIndex+9)+ ...
                    (-1*cMat(ky+i-1+my,kx-j+mx,kz-q+mz,kw+r+mw-1)+cMat(ky+i-1+my+1,kx-j+mx,kz-q+mz,kw+r+mw-1))* delta_dfx(16*nIndex+10)+ ...
                    (-1*cMat(ky-i+my,kx+j-1+mx,kz-q+mz,kw+r+mw-1)+cMat(ky-i+my+1,kx+j-1+mx,kz-q+mz,kw+r+mw-1))* delta_dfx(16*nIndex+11)+ ...
                    (-1*cMat(ky+i-1+my,kx+j-1+mx,kz-q+mz,kw+r+mw-1)+cMat(ky+i-1+my+1,kx+j-1+mx,kz-q+mz,kw+r+mw-1))* delta_dfx(16*nIndex+12)+ ...
                    (-1*cMat(ky-i+my,kx-j+mx,kz+q-1+mz,kw+r+mw-1)+cMat(ky-i+my+1,kx-j+mx,kz+q-1+mz,kw+r+mw-1))* delta_dfx(16*nIndex+13)+ ...
                    (-1*cMat(ky+i-1+my,kx-j+mx,kz+q-1+mz,kw+r+mw-1)+cMat(ky+i-1+my+1,kx-j+mx,kz+q-1+mz,kw+r+mw-1))* delta_dfx(16*nIndex+14) + ...
                    (-1*cMat(ky-i+my,kx+j-1+mx,kz+q-1+mz,kw+r+mw-1)+cMat(ky-i+my+1,kx+j-1+mx,kz+q-1+mz,kw+r+mw-1))* delta_dfx(16*nIndex+15) + ...
                    (-1*cMat(ky+i-1+my,kx+j-1+mx,kz+q-1+mz,kw+r+mw-1)+cMat(ky+i-1+my+1,kx+j-1+mx,kz+q-1+mz,kw+r+mw-1))* delta_dfx(16*nIndex+16);
